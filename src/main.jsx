...
function App() {
  ...
  return <div className="app-shell">
    ...
    <header className="site-header" id="top"><a className="brand" href="#top"><span className="brand-mark"><Layers3 size={20} /></span><span>Pixel<span>Shift</span></span></a><nav><a href="#converter">Workspace</a><a href="#features">Features</a><a href="#workflow">How it works</a></nav>{authLoading ? <div className="auth-skeleton" /> : user ? <div className="account-menu"><span className="avatar">{user.name.charAt(0).toUpperCase()}</span><div><strong>{user.name}</strong><small>Your workspace</small></div><button onClick={logout} title="Sign out"><LogOut size={16} /></button></div> : <button className="sign-in-button" onClick={() => setAuthOpen(true)}>Get started <ArrowRight size={15} /></button>}</header>
    <main>
      <section className="hero">
        <div className="hero-copy"><div className="eyebrow"><span className="eyebrow-dot" /> Your complete image workspace</div><h1>Images ready for <em>anything.</em></h1><p>Convert, compress, resize, and remove backgrounds in one beautifully simple workspace. No uploads. No complicated software.</p><div className="hero-actions"><button className="hero-primary" onClick={() => user ? document.getElementById('converter')?.scrollIntoView({ behavior: 'smooth' }) : setAuthOpen(true)}>Start creating free <ArrowRight size={18} /></button><a className="hero-secondary" href="#features"><Sparkles size={17} /> Explore features</a></div><div className="hero-proof"><span><Check size={15} /> Free to use</span><span><Check size={15} /> Files stay on your device</span><span><Check size={15} /> No watermarks</span></div><div className="hero-metrics"><div><strong>4</strong><span>essential tools</span></div><div><strong>8+</strong><span>input formats</span></div><div><strong>100%</strong><span>browser based</span></div></div></div>
        <div className="hero-product" aria-hidden="true"><div className="product-glow" /><div className="product-window"><div className="product-window-bar"><span><i /><i /><i /></span><b>PixelShift workspace</b><small>PRIVATE</small></div><div className="product-canvas"><div className="preview-stack"><div className="preview-file preview-file-source"><FileImage size={27} /><span>holiday.heic</span><b>HEIC · 4.8 MB</b></div><ArrowRight size={22} /><div className="preview-file preview-file-result"><span className="result-check"><Check size={16} /></span><span>holiday.webp</span><b>WEBP · 684 KB</b></div></div><div className="processing-pill"><span><Sparkles size={16} /></span><div><strong>Ready to download</strong><small>Processed privately in your browser</small></div></div></div><div className="product-tools"><span className="active"><RefreshCw size={15} /> Convert</span><span><Maximize2 size={15} /> Resize</span><span><Minimize2 size={15} /> Compress</span><span><Eraser size={15} /> Remove BG</span></div></div><div className="floating-badge floating-badge-top"><ShieldCheck size={16} /><span><strong>Private by design</strong><small>Nothing gets uploaded</small></span></div><div className="floating-badge floating-badge-bottom"><Bolt size={16} /><span><strong>Batch ready</strong><small>Process folders at once</small></span></div></div>
      </section>
      ...
      <section className="product-story" id="features"><div className="section-heading"><span>EVERYTHING YOU NEED</span><h2>A tiny creative studio.<br />Right inside your browser.</h2><p>Skip the app installs and scattered tools. PixelShift keeps your everyday image workflow fast, focused, and private.</p></div><div className="feature-grid"><article className="feature-card feature-private"><div className="feature-icon"><ShieldCheck size={23} /></div><span className="feature-kicker">LOCAL-FIRST</span><h3>Your images never leave your device.</h3><p>Conversion and editing happen directly in your browser, so private photos stay private.</p><div className="privacy-visual"><span><FileImage size={18} /> your-image.heic</span><i /><strong><ShieldCheck size={18} /> Processed locally</strong></div></article><article className="feature-card"><div className="feature-icon"><Archive size={23} /></div><span className="feature-kicker">BATCH WORKFLOWS</span><h3>Do a folder’s work in one pass.</h3><p>Mix formats, process complete folders, and download every result in a clean ZIP.</p><div className="mini-file-stack"><span>IMG_1042.HEIC <Check size={13} /></span><span>product-shot.PNG <Check size={13} /></span><span>portfolio.JPG <Check size={13} /></span></div></article><article className="feature-card"><div className="feature-icon"><WandSparkles size={23} /></div><span className="feature-kicker">ON-DEVICE AI</span><h3>Clean cutouts in a couple of clicks.</h3><p>Remove a background, keep it transparent, or replace it with a brand-ready color.</p><div className="swatch-row"><i className="swatch-transparent" /><i style={{ background: '#ffffff' }} /><i style={{ background: '#166b4f' }} /><i style={{ background: '#f0b84b' }} /><i style={{ background: '#ef6a5b' }} /></div></article><article className="feature-card feature-formats"><div className="feature-icon"><RefreshCw size={23} /></div><span className="feature-kicker">UNIVERSAL INPUT</span><h3>From HEIC to web-ready in seconds.</h3><p>Bring the formats your camera, phone, or design app gives you. Export clean JPG, PNG, or WebP.</p><div className="format-cloud">{['HEIC', 'AVIF', 'SVG', 'PNG', 'JPG', 'WEBP'].map((item) => <span key={item}>{item}</span>)}</div></article></div></section>
      <section className="workflow-section" id="workflow"><div className="section-heading compact"><span>A BETTER WORKFLOW</span><h2>From source to finished in three steps.</h2></div><div className="workflow-steps"><article><span>01</span><div className="workflow-icon"><UploadCloud size={23} /></div><h3>Bring your images</h3><p>Choose individual files, a full folder, or simply drag and drop.</p></article><i><ArrowRight size={20} /></i><article><span>02</span><div className="workflow-icon"><Sparkles size={23} /></div><h3>Pick your finish</h3><p>Choose a format, size, quality, or a brand-new background.</p></article><i><ArrowRight size={20} /></i><article><span>03</span><div className="workflow-icon"><Download size={23} /></div><h3>Save and ship</h3><p>Download one result, a ZIP, or write a complete folder directly.</p></article></div></section>
      <section className="bottom-cta"><div><span>READY WHEN YOU ARE</span><h2>Your next image is one drop away.</h2><p>Open the workspace and turn raw files into polished assets—privately, right in your browser.</p></div><button onClick={() => user ? document.getElementById('converter')?.scrollIntoView({ behavior: 'smooth' }) : setAuthOpen(true)}>Open PixelShift <ArrowRight size={18} /></button></section>
    </main>
    <footer><a className="brand footer-brand" href="#top"><span className="brand-mark"><Layers3 size={17} /></span><span>Pixel<span>Shift</span></span></a><p>Beautifully simple image tools, built for the browser.</p><nav><a href="#converter">Workspace</a><a href="#features">Features</a><a href="#workflow">How it works</a></nav><small>Private by design · Free to use</small></footer>
